...
const call = () => {
  return (
    ...
    <div className=" sticky-top">
       ...
       <Link to="/contact">
                      <div className="mr-5  w-16 px-4 py-3 bg-slate-200 font-medium bg-primary-inverse text-primary-inverse leading-5 rounded-full flex items-center justify-center space-x-3 truncate cursor-pointer">
                        <div className="mm">
